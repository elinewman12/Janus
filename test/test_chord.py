...
def test_chord_names():
    ...
    assert orig.tracks[0].chords[0].name == "C Major"
    assert orig.tracks[0].chords[1].name == "C Major Seventh"
    assert orig.tracks[0].chords[2].name == "D Minor"
    assert orig.tracks[0].chords[3].name == "D Minor Seventh"
