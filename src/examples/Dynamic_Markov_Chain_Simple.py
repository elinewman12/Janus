...
chords = chord_chain.generate_pattern(output_song, num_notes=16, instrument=24, octave=4)
melody = note_chain.generate_pattern(output_song, num_notes=64, instrument=32, octave=5)
